...
async def main():
    ...
    answer_checking = pygame.mixer.Sound(os.path.join("answer_checking.ogg"))
    congratulations = pygame.mixer.Sound(os.path.join("congratulations.ogg"))
    correct = pygame.mixer.Sound(os.path.join("correct.ogg"))
    incorrect = pygame.mixer.Sound(os.path.join("incorrect.ogg"))
    regi_chosen = pygame.mixer.Sound(os.path.join("regi_chosen.ogg"))
    regi_gained = pygame.mixer.Sound(os.path.join("regi_gained.ogg"))
